...
+--------------------------------------------------------*/
if (isset($_GET['captcha_code']) && ctype_alnum($_GET['captcha_code']) && preg_match("/^[0-9A-Za-z]+$/", $_GET['captcha_code'])) {
	...
	$cresult = mysql_query("SELECT captcha_string FROM ".DB_CAPTCHA." WHERE captcha_encode='".$_GET['captcha_code']."'");
